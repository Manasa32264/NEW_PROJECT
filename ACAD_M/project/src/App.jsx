          ...
          >
            <div className="min-h-screen custom-beige flex items-center justify-center">
              <div className="text-center p-8">
                <h1 className="text-4xl font-bold custom-brown mb-4">Study Materials</h1>
                <p className="text-xl custom-brown opacity-80">Access comprehensive study resources and materials</p>
              </div>
            </div>
          </ProtectedRoute>
        );
