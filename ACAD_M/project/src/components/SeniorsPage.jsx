  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 py-10 page-container">
        ...
        <div className="grade-header flex justify-between items-center mb-6">
          <h2 className="grade-title text-3xl font-bold">👥 Meet Our Senior Mentors</h2>
          <button className="btn back-btn px-4 py-2 bg-accent text-white rounded-lg" onClick={onBackToHome}>
            ← Back to Home
          </button>
        </div>
